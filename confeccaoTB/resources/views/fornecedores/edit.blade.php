<x-app-layout>
    ...
    <i class="ph-bold ph-phone text-2xl text-slate-300"></i>
    <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $fornecedore->telefone) }}"
           class="w-full border-none bg-transparent py-6 px-4 focus:ring-0 text-slate-800 font-bold">
</div>
                            </div>
                        </div>
    ...
    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $fornecedore->cnpj) }}" required
           class="w-full border-none bg-transparent py-6 px-4 focus:ring-0 text-slate-800 font-bold">
</div>
                        </div>
